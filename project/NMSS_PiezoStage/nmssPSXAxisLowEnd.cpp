/*********************************************************************
** Returns the low end of the travel range of the X-Axis (axis 1)
** NanoBioTech Group - Uni Mainz
** Date:		2007-08-13
** Filename:	nmssPSXAxisLowEnd.cpp
** Author:		Arpad Jakab
** 
                 ...
                 int nrhs, const mxArray *prhs[])
{
	...
	if (nrhs != 1)
    {
		mexPrintf("\nUsage: nmssPSXAxisLowEnd(<controller_handle>), where <controller_handle> must be a valid controller handle.");
		mexPrintf("\n");
        return;
    }
	...
	try
	{
		...
		double dRet[1];
		if (!E7XX_qTMN (iControllerHandle, "1", dRet)) throw true;
